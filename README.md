...
> [Typed array][mdn-typed-array] constructor which returns a [typed array][mdn-typed-array] representing an array of 64-bit signed integers in the platform byte order.
...
```bash
npm install @stdlib/array-bigint64
```
...
```javascript
var BigInt64Array = require( '@stdlib/array-bigint64' );
```

#### BigInt64Array()

A [typed array][mdn-typed-array] constructor which returns a [typed array][mdn-typed-array] representing an array of 64-bit signed integers in the platform byte order.
...
```javascript
var arr = new BigInt64Array( 5 );
// returns <BigInt64Array>[ 0, 0, 0, 0, 0 ]
```
...
var arr1 = new Int32Array( [ 1, 2, 3, 4 ] );
var arr2 = new BigInt64Array( arr1 );
// returns <BigInt64Array>[ 1, 2, 3, 4 ]
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/array-bigint64.svg
[npm-url]: https://npmjs.org/package/@stdlib/array-bigint64

[test-image]: https://github.com/stdlib-js/array-bigint64/actions/workflows/test.yml/badge.svg
[test-url]: https://github.com/stdlib-js/array-bigint64/actions/workflows/test.yml

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/array-bigint64/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/array-bigint64?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/array-bigint64.svg
[dependencies-url]: https://david-dm.org/stdlib-js/array-bigint64/main
...
[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/array-bigint64/main/LICENSE
